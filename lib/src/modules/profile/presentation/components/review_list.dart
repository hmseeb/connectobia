...
class ReviewCard extends StatelessWidget {
  ...
  String _getReviewerName() {
    try {
      // Check if it's a brand review
      if (review.fromBrand != null && review.fromBrand!.isNotEmpty) {
        if (review.brandRecord != null) {
          return review.brandRecord['brandName'] ?? 'Brand';
        }
        return 'Brand';
      }
      // Check if it's an influencer review
      else if (review.fromInfluencer != null &&
          review.fromInfluencer!.isNotEmpty) {

  ...
  static Future<List<Campaign>> getCampaigns() async {
    ...
    return [
      Campaign(
        ...
        description: 'Unwind and rejuvenate at a luxury spa retreat in the heart of Bali.',
        rating: 4.7,
        distance: '5.7 km',
        price: '\$24',
      ...
      Campaign(
        ...
        description: 'Discover the rich history of Rome through a unique cultural tour.',
        rating: 4.8,
        distance: '10 km',
        price: '\$30',
        created: DateTime.now(),
